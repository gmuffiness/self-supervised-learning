...
def resnet50x1(num_classes=1000, **kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], width_mult=1, num_classes=num_classes)

def resnet50x2(num_classes=1000, **kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], width_mult=2, num_classes=num_classes)

def resnet50x4(num_classes=1000, **kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], width_mult=4, num_classes=num_classes)